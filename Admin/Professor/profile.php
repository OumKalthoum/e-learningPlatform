                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="card card-primary">
                                <div class="card-body">
                                    <strong><i class="fas fa-book mr-1"></i>Total cours: 34</strong>
                                    <hr>
                                    <strong><i class="fas fa-copy mr-1"></i>Total Evaluations :  12</strong>
                                    <hr>
                                    <strong><i class="ion ion-person mr-1"></i>Total inscription : 67</strong>
                                </div>
                                <!-- /.card-body -->
                            </div>
                            <!-- /.card -->
